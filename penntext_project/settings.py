...
STATIC_PATH = os.path.join(os.path.abspath(os.path.join(BASE_DIR, os.pardir)), "TempTest\static")
STATIC_URL = '/static/'
STATICFILES_DIRS = (
    STATIC_PATH,
)
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(os.path.abspath(os.path.join(BASE_DIR, os.pardir)), "TempTest\media")
